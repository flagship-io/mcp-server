...
- Envelope: `needs_clarification` (boolean), `questions` (array of strings), and a payload with one or more resource operations.
- Campaign resource: `"type": "campaign"`, `$_ref`, `"action": "create"`, and a fully specified `"payload"` with variation_groups.
...
- **Version field:**
  - Always include `"version": 1` at the top level of the output JSON
- **Resources array:**
